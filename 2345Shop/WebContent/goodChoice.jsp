...
<html>
		...
		<div id="b">
			...
			<div class="fl aa">
				<form action="#">
					...
					<input name="jgqj1" class="min-price" placeholder="￥" value="">
					<span>-</span>
					<input name="jgqj2" class="max-price" placeholder="￥" value="">
					<button class="" id="sortSeachSubmit">确认</button>
				</form>
			</div>
			<div id="san">
				<span>
	...
	<c:if test="${sessionScope.cgPage1==null}">
			<jsp:forward page="GoodChoiseServlet?action=cgPage"></jsp:forward>
		</c:if> 
	<div id="four">
		<ul>
		
			<c:forEach var="cg" items="${sessionScope.cgPage1.lists }">
	...
	<div  id="page">
				<h3>
					<a href="GoodChoiseServlet?cgcurrentPage1=1&action=cgPage">首页</a>
					<a href="GoodChoiseServlet?cgcurrentPage1=${sessionScope.cgPage1.currentPage-1<1?1:sessionScope.cgPage1.currentPage-1}&action=cgPage">上一页</a>
					<a href="GoodChoiseServlet?cgcurrentPage1=${sessionScope.cgPage1.currentPage+1>sessionScope.cgPage1.totalPage?sessionScope.cgPage1.totalPage:sessionScope.cgPage1.currentPage+1}&action=cgPage">下一页</a>
					<a href="GoodChoiseServlet?cgcurrentPage1=${sessionScope.cgPage1.totalPage}&action=cgPage">尾页</a>
				</h3>
			</div>
	<div id="five">
			<ul>
