...
<div> 
    ...
    <div class="w940">
      <div class="header clearfix">
        ...
        <div class="welcome fl">
        	...
        	<a href="managerGoodChoice.jsp" style="color:black;">好货精选管理</a>&nbsp;>&nbsp;添加好货精选</div>
      </div>
    </div>
  </div>
 ...
 <div id="car">
 	...
 	<div class="add">
		...
		<form  action="GoodChoiseServlet?action=save" enctype="multipart/form-data" method="post">
			...
			<table border="0">
				...
				<tr><td><label>分类：</label></td><td><input type="text" name="descri"  value=""/></td></tr>
				<tr><td><label>价格：</label></td><td><input type="text" name="price"  value=""/></td></tr>
				<tr><td><label>原价：</label></td><td><input type="text" name="pririce"  value=""/></td></tr>
				<tr><td><label>优惠：</label></td><td><input type="text" name="youhui"  value=""/></td></tr>
				<tr><td><label>销量：</label></td><td><input type="text" name="xiaoliang"  value="" style="width:202px;"/>(单位:万)</td></tr>
