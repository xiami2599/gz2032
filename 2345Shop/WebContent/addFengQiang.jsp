...
<div> 
    ...
    <div class="w940">
      <div class="header clearfix">
        ...
        <div class="welcome fl">
	        ...
	        <a href="managerFengQiang.jsp" style="color:black;">疯抢榜管理</a>&nbsp;>&nbsp;添加疯抢榜</div>
      </div>
    </div>
  </div>
 ...
 <div id="car">
 	...
 	<div class="add">
		...
		<form  action="FengQiangServlet?action=save" enctype="multipart/form-data" method="post">
			...
			<table border="0">
				...
				<tr><td><label>销量：</label></td><td><input type="text" name="xiaoliang"  value="" /></td></tr>
