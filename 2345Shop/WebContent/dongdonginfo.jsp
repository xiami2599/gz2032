...
<div> 
 ...
 <div id="info" class="">
			...
			<div id="left">
				<img src="upload/${ddqInfo.picpath}" id="infodatu"/>
			...
			<div id="right">
				<table border="0" width="550px" height="170px">
					...
					<tr><td colspan="2"><p>${sessionScope.ddqInfo.title}</p></td></tr>
					<tr><td>${ddqInfo.descri}</td><td>累计销量：20万</td></tr>
					<tr><td>独家优惠：<span id="quan">10元券</span></td><td></td></tr>
				</table>
				<hr />
				
				<div id="btm"> 
					<span id="price">￥${ddqInfo.price}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;原价：<span id="prix">${ddqInfo.pririce}</span>
					
					<a href="CarServlet?carName=${ddqInfo.title }&picPath=${ddqInfo.picpath }&price=${ddqInfo.price }&count=${1 }&TotalPrice=${ddqInfo.price }&uid=${user.id }&action=save" id="buy">
					加入购物车</a>
				</div>
			</div>
		</div>
